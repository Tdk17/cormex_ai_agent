          ...
          builder: (BuildContext context, BoxConstraints constraints) {
            ...
            final children = <Widget>[
              ...
              _DetailCard(
                ...
                rows: <({String label, String value})>[
                  (label: 'Status', value: _label(campaign.status)),
                  (label: 'Canais ativos', value: campaign.channels.map(_label).join(' + ')),
...
String _label(String value) => switch (value) {
      ...
      'paused' => 'Pausada',
      'finished' => 'Encerrada',
      'authorization_error' => 'Autorização necessária',
      'publication_error' => 'Falha na publicação',
      'payment_issue' => 'Pendência de pagamento',
